...
export const clinicApi = {
  ...
  getPatients: async (params?: any) => {
    const response = await axiosInstance.get('/v1/clinic/patients', { params });
    return response.data;
  },

  createPatient: async (data: any, params?: any) => {
    const response = await axiosInstance.post('/v1/clinic/patients', data, { params });
    return response.data;
  },
};
