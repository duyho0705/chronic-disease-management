                        ...
                        {isLoading ? (
                          [...Array(5)].map((_, i) => (
                            <tr key={i} className="animate-pulse">
                              ...
                              <td className="px-6 py-4 text-right"><div className="h-8 w-8 bg-slate-200 dark:bg-slate-800 rounded-full ml-auto"></div></td>
                            </tr>
                          ))
                        ) : (
                          <>
                              ...
                              <td className="px-6 py-4">
                                <div className="flex gap-4">
                                  ...
                                  <div className="text-[13px]">
                                    ...
                                    <p className="font-bold text-[14px] text-slate-700 dark:text-slate-200">23.4</p>
                                  </div>
                                </div>
                              </td>
                              <td className="px-6 py-4">
                                <div className="px-4 py-1.5 bg-amber-500 text-white text-[13px] font-bold rounded-full shadow-sm whitespace-nowrap inline-flex">Cần theo dõi</div>
                              </td>
                              <td className="px-6 py-4 text-[14px] text-slate-500 font-medium">3 giờ trước</td>
                              <td className="px-6 py-4 text-right relative">
                                <button
