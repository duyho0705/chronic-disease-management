...
@Table(name = "health_metrics", indexes = {
    @Index(name = "idx_metrics_patient_type_date", columnList = "patient_id, metric_type, measured_at"),
    @Index(name = "idx_metrics_patient_date", columnList = "patient_id, measured_at DESC")
})
@Getter
@Setter
@NoArgsConstructor
